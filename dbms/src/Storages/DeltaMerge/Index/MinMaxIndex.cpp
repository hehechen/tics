...
void MinMaxIndex::addPack(const IDataType &, const IColumn & column, const ColumnVector<UInt8> * del_mark)
{
...
MinMaxIndexPtr MinMaxIndex::read(const IDataType & type, ReadBuffer & buf, size_t bytes_limit, bool check_bytes_limit)
{
    UInt64 size = 0;
    ...
    if (check_bytes_limit && unlikely(bytes_read != bytes_limit))
    {
