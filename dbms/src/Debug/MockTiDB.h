...
public:
    TableID newTable(const String & database_name, const String & table_name, const ColumnsDescription & columns, TiDBTimestamp tso, const String & handle_pk_name, const String & engine_type);
    ...
    void newPartition(const String & database_name, const String & table_name, TableID partition_id, TiDBTimestamp tso, bool);
